...
const Booked = ({bus, time, destination, setDate}) => {
        ...
        exit={{x: window.innerWidth}}>
            ...
            <div className="booked-section" id="payment-section">
                <div className="payment-option">
                    ...
                    <label>Pay with credit card {<BsFillCreditCard2FrontFill className="icon"/>}</label>
                ...
                <div className="payment-option">
                    ...
                    <label>Tap with metro card {<BsFillCreditCard2BackFill className="icon"/>}</label>
                </div>
            </div>
            ...
            <Link to="/" className="action-button" id="cancel" onClick={() => setDate(null)}>Cancel</Link>
        </motion.div>
    )
}
